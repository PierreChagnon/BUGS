...
public class TrialManager : MonoBehaviour
{
    ...
    TrialResponseRow BuildBaseRow()
    {
        ...
        return new TrialResponseRow
        {
            ...
            advisor_options = block != null ? FlowCloneUtility.CloneArray(block.advisor_options) : new[] { "none", "human", "robot" },
            ...
            grid_width = map != null ? map.grid_width : 0,
            grid_height = map != null ? map.grid_height : 0,
