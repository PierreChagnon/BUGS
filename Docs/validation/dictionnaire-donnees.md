...
| `acceptability_question_2` | string | `1`…`7` | Réponse 2e question dimension « acceptabilité ». Même échelle, même règle sans advisor. (Q-011) |
| `sens_of_agency_question` | string | `1`…`7` | Réponse dimension « sense of agency ». Échelle à 7 points saisie par **7 boutons radio**. (Q-011) |
| `human_likeness_question` | string | `1`…`7` | Réponse dimension « human-likeness ». 7 boutons radio. Posée **une seule fois par bloc** (au dernier trial), puis renseignée via PATCH. ⚠️ **La réponse est recopiée sur TOUTES les lignes du bloc**, pas seulement la dernière (`ApiClient.cs:150-186`) — cf. §Limites n°8. (Q-011, Q-HL-1) |
