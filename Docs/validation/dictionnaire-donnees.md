...
| Colonne | Type | Domaine | Description |
| :-- | :-- | :-- | :-- |
| `acceptability_question_1` | string | `1`…`5` | Réponse 1re question dimension « acceptabilité ». Échelle Likert à **5 points** (1 = pas du tout d'accord → 5 = tout à fait d'accord). **Vide quand `advisor_choice = none`** : la question n'est délibérément pas posée (`TrialQuestionsUI.cs`). (mapping et textes à confirmer — Q-011 ; valeur attendue sans advisor — Q-DATA-1) |
| `acceptability_question_2` | string | `1`…`5` | Réponse 2e question dimension « acceptabilité ». Même échelle, même règle sans advisor. (Q-011) |
