...
1. **Arbitrages chercheur bloquants** — **décision sur QuestionnaireScene** (E1), dernier restant. (~~Q-010~~ ✅ RÉSOLUE le 09/09 — DEC-037 ; ~~Q-011~~ ✅ RÉPONDUE le 09/09 — DEC-035 + `746a4406`.) ~~Texte de consentement (E2)~~ ✅ réglé le 08/09. Rien d'autre ne peut être figé sans ça.
