...
Unity **6000.3.5f2** · URP 17.3.0 · New Input System · WebGL. Version build : `BuildInfo.Version` (**1.3.0**, bumpée à chaque build livrée — convention dans `backend-bugs/AGENTS.md`).
